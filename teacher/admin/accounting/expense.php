...
<form action="<?php echo base('admin', 'expense_date_search_result');?>" method="post" target="_blank">
    <div class="row">
        <div class="col-md-1">
            <p>Date Search: </p>
        </div>
        ...
        <tr>
            ...
            <td>
                <a href="#" class="btn btn-xs btn-info" onclick="showAjaxModal('<?php echo base_url();?>index.php?modal/popup/expense_edit/<?php echo $row['payment_id'];?>');">
                                ...
                                <a href="#" class="btn btn-xs btn-danger" onclick="confirm_modal('<?php echo base_url();?>index.php?admin/expense/delete/<?php echo $row['payment_id'];?>');">
