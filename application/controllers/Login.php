...
class Login extends CI_Controller {
    ...
    function ajax_login() {
        ...
        if ($login_status == 'success') {
            ...
            $this->session->set_flashdata('loginfail' , get_phrase('Userid or Password Invalid.'));
    ...
    function ajax_forgot_password()
    {
        ...
        $value = 'Reset email has been sent.';
        $this->session->set_flashdata('loginsuccess', $value);
        redirect(base('login', ''));
