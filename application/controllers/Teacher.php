...
class Teacher extends CI_Controller
{
    ...
    function ajaxStudentSearch()
    {
        ...
        $this->load->view('backend/teacher/ajax_student_search' , $page_data);
    }
    ...
    function student_bulk_add($param1 = '')
    {
        ...
        if($param1 == 'add_bulk_student') {
            ...
            redirect(base_url() . 'index.php?teacher/student_information/' . $this->input->post('class_id') , 'refresh');
        }
    ...
    function get_sections($class_id)
    {
        ...
        $this->load->view('backend/teacher/student_bulk_add_sections' , $page_data);
    }
    ...
    function student_promotion($param1 = '' , $param2 = '')
    {
        ...
        if($param1 == 'promote') {
            ...
            redirect(base_url() . 'index.php?teacher/student_promotion' , 'refresh');
        }
    ...
    function update_new_promotion_std_info()
    {
        ...
        $this->session->set_flashdata('flash_message' , get_phrase('new_enrollment_successfull'));
        redirect(base_url() . 'index.php?teacher/student_information/'.$info['class_id'] , 'refresh');
    }
    ...
    function print_testimonial_voc($page_data = '')
    {
        ...
        $page_data['page_title'] = get_phrase('testimonial_for_vocational');
        $this->load->view('backend/teacher/print_testimonial_voc' , $page_data);
    }
    ...
    function print_testimonial_general($page_data = '')
    {
        ...
        $page_data['page_title'] = get_phrase('testimonial_for_general');
        $this->load->view('backend/teacher/print_testimonial_general' , $page_data);
    }
    ...
    function ajax_teacher_menu_pages()
    {
        ...
        $page_data['running_year'] = $this->running_year;
        $page_data['page_name'] = $pageName;
        $this->load->view('backend/teacher/teacher/'.$pageName, $page_data);
    }
    ...
    function ajaxTeacherRoutine()
    {
        ...
        if(!empty($teacher_id)){
            ...
            $this->load->view('backend/teacher/teacher/ajax_teacher_routine' , $page_data);
        }
    }
    ...
    {
        $htmlData = $this->load->view('backend/teacher/teacher/teacher' , '', true);
    ...
    function ajax_edit_teacher()
    {
        ...
        $page_data['running_year'] = $this->running_year;
        $htmlData = $this->load->view('backend/teacher/teacher/teacher_edit_holder' , $page_data, true);
    ...
    function ajax_subject_table_holder($class_id)
    {
        ...
        $htmlData = $this->load->view('backend/teacher/ajax_elements/subject_table_holder', $page_data, true);
    ...
    function ajax_edit_subject()
    {
        ...
        $page_data['class_id']   = $class_id;
        $htmlData = $this->load->view('backend/teacher/ajax_elements/edit_subject_holder' , $page_data, true);
    ...
    function ajax_create_classes()
    {
        ...
        if(!$check){
            ...
            $page_data['classes']    = $this->db->get('class')->result_array();
            $htmlData = $this->load->view('backend/teacher/ajax_elements/class_table_holder' , $page_data, true);
    ...
    function ajax_edit_class()
    {
        $class_id = $this->uri(3);
        $page_data['class_id']   = $class_id;
        $htmlData = $this->load->view('backend/teacher/ajax_elements/edit_class_holder' , $page_data, true);
        $this->jsonMsgReturn(true,'Edit Moad ON',$htmlData);
    }
    ...
    function shifts($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?teacher/shifts/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']         = $this->input->post('name');
    ...
    function ajax_create_shift()
    {
        ...
        if(!$check){
            ...
            $page_data['shifts']    = $this->db->get('shift')->result_array();
            $htmlData = $this->load->view('backend/teacher/ajax_elements/shift_table_holder' , $page_data, true);
    ...
    function ajax_edit_shift()
    {
        ...
        $htmlData = $this->load->view('backend/teacher/ajax_elements/edit_shift_holder' , $page_data, true);
        $this->jsonMsgReturn(true,'Edit Moad ON',$htmlData);
    }
    ...
    function groups($param1 = '', $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?teacher/groups/', 'refresh');
        }
        if ($param1 == 'do_update') {
            $data['name']         = strtolower(str_replace(' ', '-', $this->input->post('name')));
            $data['class_id']         = $this->input->post('class_id');
    ...
    function ajax_create_group()
    {
        ...
        if(!$check){
            ...
            $page_data['groups']    = $this->db->get('group')->result_array();
            $page_data['classes']    = $this->db->get('class')->result_array();
            $htmlData = $this->load->view('backend/teacher/ajax_elements/group_table_holder' , $page_data, true);
    ...
    function ajax_edit_group()
    {
        ...
        $page_data['group_id']   = $group_id;
        $page_data['classes']    = $this->db->get('class')->result_array();
        $htmlData = $this->load->view('backend/teacher/ajax_elements/edit_group_holder' , $page_data, true);
        $this->jsonMsgReturn(true,'Edit Moad ON',$htmlData);
    }
    ...
    function ajax_income_category_create()
    {
        ...
        if(!$check){
            ...
            $htmlData = $this->load->view('backend/teacher/ajax_elements/income_category_table_holder' , '', true);
            $this->jsonMsgReturn(true,'Edit Success.',$htmlData);
        }
    }
    ...
    function ajax_income_category_edit()
    {
        ...
        $htmlData = $this->load->view('backend/teacher/ajax_elements/edit_income_category_holder', $page_data, true);
        $this->jsonMsgReturn(true,'Edit Moad ON',$htmlData);
    }
    ...
    function ajax_expense_category_create()
    {
        ...
        if(!$check){
            ...
            $htmlData = $this->load->view('backend/teacher/ajax_elements/expense_category_table_holder' , '', true);
    ...
    function ajax_expense_category_edit()
    {
        ...
        $htmlData = $this->load->view('backend/teacher/ajax_elements/edit_expense_category_holder', $page_data, true);
        $this->jsonMsgReturn(true,'Edit Moad ON',$htmlData);
    }
    ...
    function ajax_daily_expense_add()
    {
        ...
        if(!$check){
            ...
            $htmlData = $this->load->view('backend/teacher/ajax_elements/daily_expense_table_holder' , '', true);
            $this->jsonMsgReturn(true,'Success.',$htmlData);
        }
    }
    ...
    function ajax_daily_expense_edit()
    {
        ...
        $htmlData = $this->load->view('backend/teacher/ajax_elements/edit_daily_expense_holder', $page_data, true);
        $this->jsonMsgReturn(true,'Edit Moad ON',$htmlData);
    }
    ...
    function ajax_add_bank_account()
    {
        ...
        if(!$check){
            ...
            $htmlData = $this->load->view('backend/teacher/ajax_elements/bank_ac_table_holder' , $page_data, true);
            $this->jsonMsgReturn(true,'Success.',$htmlData);
        }
    }
    ...
    function ajax_edit_bank_ac()
    {
        ...
        if(!$check){
            ...
            $htmlData = $this->load->view('backend/teacher/ajax_elements/edit_bank_ac_holder', $page_data, true);
            $this->jsonMsgReturn(true,'Success.',$htmlData);
        }
    }
    ...
    function ajax_add_bank_transaction()
    {
        ...
        if(!$check){
            ...
            $htmlData = $this->load->view('backend/teacher/ajax_elements/bank_transaction_table_holder' , $page_data, true);
            $this->jsonMsgReturn(true,'Success.',$htmlData);
        }
    }
    ...
    function ajax_transaction_search_date_wise()
    {
        ...
        if(!$check){
            ...
            $htmlData = $this->load->view('backend/teacher/ajax_elements/bank_transaction_search_result', $page_data, true);
            $this->jsonMsgReturn(true,'Success.',$htmlData);
        }
    }
    ...
    function ajax_monthly_balance_year()
    {
        ...
        $htmlData = $this->load->view('backend/teacher/ajax_elements/monthly_balance_table_holder' , $page_data, true);
    ...
    function ajax_upload_academic_syllabus()
    {
        ...
        if(!$check){
            ...
            $page_data['running_year'] = $this->running_year;
            $htmlData = $this->load->view('backend/teacher/ajax_elements/academic_syllabus_table_holder' , $page_data, true);
    ...
    function sections($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_added_successfully'));
            redirect(base_url() . 'index.php?teacher/section/' . $data['class_id'] , 'refresh');
        }
        ...
        if ($param1 == 'delete') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_deleted'));
            redirect(base_url() . 'index.php?teacher/section' , 'refresh');
        }
    }
    ...
    function ajax_create_section()
    {
        ...
        if(!$check){
            ...
            $htmlData = $this->load->view('backend/teacher/ajax_elements/section_table_holder' , '', true);
    ...
    function ajax_edit_section()
    {
        ...
        $htmlData = $this->load->view('backend/teacher/ajax_elements/edit_section_holder' , $page_data, true);
        $this->jsonMsgReturn(true,'Edit Moad ON',$htmlData);
    }
    ...
    function exam_marks_sms($param1 = '' , $param2 = '')
    {
        ...
        if ($param1 == 'send_sms') {
            ...
            redirect(base_url() . 'index.php?teacher/exam_marks_sms' , 'refresh');
        }
    ...
    function marks2($exam_id = '', $class_id = '', $subject_id = '')
    {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['exam_id'] > 0 && $page_data['class_id'] > 0 && $page_data['subject_id'] > 0) {
                redirect(base_url() . 'index.php?teacher/marks2/' . $page_data['exam_id'] . '/' . $page_data['class_id'] . '/' . $page_data['subject_id'], 'refresh');
            } else {
                $this->session->set_flashdata('mark_message', 'Choose exam, class and subject');
                redirect(base_url() . 'index.php?teacher/marks2/', 'refresh');
            }
        }
        if ($this->input->post('operation') == 'update') {
            ...
            $this->session->set_flashdata('flash_message' , get_phrase('data_updated'));
            redirect(base_url() . 'index.php?teacher/marks2/' . $this->input->post('exam_id') . '/' . $this->input->post('class_id') . '/' . $this->input->post('subject_id'), 'refresh');
        }
        $page_data['exam_id']    = $exam_id;
        $page_data['class_id']   = $class_id;
        $page_data['subject_id'] = $subject_id;
    ...
    function ajax_marks_manage_view($exam_id = '' , $class_id = '' , $section_id = '' , $subject_id = '', $group_id = '', $foundRolls = [])
    {
        ...
        $htmlData = $this->load->view('backend/teacher/ajax_elements/ajax_marks_manage_view' , $page_data, true);
    ...
    function marks_selector()
    {
        ...
        redirect(base_url() . 'index.php?teacher/marks_manage_view/' . $data['exam_id'] . '/' . $data['class_id'] . '/' . $data['section_id'] . '/' . $data['subject_id']. '/' . $data['group_id'] , 'refresh');
    ...
    function marks_update($exam_id = '' , $class_id = '' , $section_id = '' , $subject_id = '',$group_id = '')
    {
      ...
      foreach ($_POST['marks_obtained'] as $key => $value) {
        ...
        // redirect(base_url().'index.php?teacher/marks_manage_view/'.$exam_id.'/'.$class_id.'/'.$section_id.'/'.$subject_id.'/'.$group_id , 'refresh');
    }
    ...
    function tabulation_sheet($class_id = '' , $exam_id = '') {
        ...
        if ($this->input->post('operation') == 'selection') {
            ...
            if ($page_data['exam_id'] > 0 && $page_data['class_id'] > 0) {
                redirect(base_url() . 'index.php?teacher/tabulation_sheet/' . $page_data['class_id'] . '/' . $page_data['exam_id'] , 'refresh');
            } else {
    ...
    function ajaxClassRoutine()
    {
        ...
        $this->load->view('backend/teacher/ajax_elements/ajax_class_routine_search' , $page_data);
    }
    ...
    function ajax_class_routine_add()
    {
        $page_data['page_name']  = 'class_routine_add';
        $page_data['page_title'] = get_phrase('add_class_routine');
        $this->load->view('backend/teacher/class_routine_add', $page_data);
    }
    ...
    function ajax_manage_attendance_view($class_id = '' , $shift_id = '' , $section_id = '' , $timestamp = '',$group_id = '')
    {
        ...
        $page_data['section_id'] = $section_id;
        $page_data['running_year'] = $this->running_year;
        $this->load->view('backend/teacher/manage_attendance_view', $page_data);
    }
    ...
    function get_group($class_id)
    {
        ...
        if(!empty($groupInfo)){
            ...
            $this->load->view('backend/teacher/manage_attendance_group_holder' , $page_data);
        }else{
            return false;
        }
    ...
    function attendance_selector()
    {
        ...
        redirect(base_url().'index.php?teacher/manage_attendance_view/'.$data['class_id'].'/'.$data['shift_id'].'/'.$data['section_id'].'/'.$data['timestamp'].'/'.$group_id,'refresh');
    }
    ...
    function attendance_update($class_id = '' , $shift_id = '', $section_id = '' , $timestamp = '', $group_id = '')
    {
        ...
        //redirect(base_url().'index.php?teacher/manage_attendance_view/'.$class_id.'/'.$shift_id.'/'.$section_id.'/'.$timestamp.'/'.$group_id , 'refresh');
    ...
    function attendance_selector2()
    {
     ...
     function ajax_attendance_report_view($class_id = '' ,$shift_id = '' , $section_id = '', $month = '', $group_id = '')
     {
        ...
        $page_data['page_name'] = 'attendance_report_view';
        $page_data['section_id'] = $section_id;
        $this->load->view('backend/teacher/attendance_report_view', $page_data);
     }
    ...
    function attendance_report_selector()
    {
        ...
        $data['section_id'] = $this->input->post('section_id');
        redirect(base_url().'index.php?teacher/attendance_report_view/'.$data['class_id'].'/'.$data['shift_id'].'/'.$data['section_id'].'/'.$data['month'].'/'.$group_id,'refresh');
    }
    ...
    function ajax_upload_school_info()
    {
        ...
        $this->db->update('settings',['description'=>$data],['type'=>'school_information']);
        move_uploaded_file($_FILES['userfile']['tmp_name'], 'uploads/school_logo.png');
        $htmlData = $this->load->view('backend/teacher/ajax_elements/school_setting_info_holder' , '', true);
        $this->jsonMsgReturn(true,'Information Updated.',$htmlData);
    }
    ...
    function ajax_update_system_generalInfo()
    {
        ...
        if(!$check){
            ...
            $htmlData = $this->load->view('backend/teacher/ajax_elements/genarel_setting_info_holder' , '', true);
            $this->jsonMsgReturn(true,'Information Updated.',$htmlData);
        }
    ...
    {
        $this->load->view('backend/teacher/change_session');
    }
    ...
    function ajax_change_site_color()
    {
        ...
        if(!$check){
            ...
            $this->db->update('frontpages',['description'=>$mainColor],['title'=>'main_color']);
            $this->db->update('frontpages',['description'=>$hoverColor],['title'=>'hover_color']);
            $htmlData = $this->load->view('backend/teacher/ajax_elements/update_site_color_info' , $page_data, true);
            $this->jsonMsgReturn(true,'Information Updated.',$htmlData);
        }
    }
    ...
    function ajax_update_site_status()
    {
    	...
    	if(!empty($_POST['status'])){
    		...
    		$htmlData = $this->load->view('backend/teacher/ajax_elements/site_status_holder' , $page_data, true);
    ...
    function update( $task = '', $purchase_code = '' )
    {
        ...
        redirect(base_url() . 'index.php?teacher/system_settings');
    }
    ...
    function librarian($param1 = '', $param2 = '', $param3 = '')
    {
        ...
        if ($param1 == 'create') {
            ...
            redirect(base_url() . 'index.php?teacher/librarian/', 'refresh');
        }
    ...
    function get_database_table($table_name)
    {
        ...
        $this->load->view('backend/teacher/get_database_table', $fields);
    }
    ...
    function code_edit()
    {
        $this->load->view('backend/teacher/code_edit');
    }
