    ...
    <div class="panel panel-primary" data-collapsed="0">
        <div class="panel-heading">
            <div class="panel-title">
                ...
                <?php echo get_phrase('download_admit'); ?>
            </div>
        </div>
        <div class="panel-body">


            <form action="<?php echo base('admin', 'download_admit_card');?>" method="post" class="form-horizontal form-groups-bordered validate" target="_blank">
            ...
            ?>
                ...
                <div class="form-group">
                    <label for="field-2" class="col-sm-3 control-label">
                        <?php echo get_phrase('rolls'); ?>
                    </label>
                    <div class="col-sm-6">
                        <input type="text" class="form-control" name="rolls" placeholder="Use comma to separate each roll" />
                    </div>
                </div>
