...
<form id="updateSlider" action="<?php echo base_url() .'index.php?homemanage/ajax_update_slider'; ?>" class="form-horizontal form-groups-bordered" method="post" enctype="multipart/form-data">
    ...
    $('#updateSlider').ajaxForm({
      ...
      success: function (data) {
          ...
          if (!jData.type) {
              ...
              $("#sliderFormSection").html(jData.html.addForm);             
              $("#sliderImageHolder").html(jData.html.imageHolder);            
          }
          $('body,html').animate({
              scrollTop: 0
          }, 800);
