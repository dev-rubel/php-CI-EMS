                            ...
                            ?>
                                    <div class="btn-group" id="routine<?php echo $row2['class_routine_id'];?>">
                                        ...
                                        if ($row2['time_start_min'] == 0 && $row2['time_end_min'] == 0) 
                                            ...
                                            echo date("g:i a", strtotime($row2['time_start'].':'.$row2['time_end']));
                                        if ($row2['time_start_min'] != 0 || $row2['time_end_min'] != 0)
                                            echo '('.date("g:i", strtotime($row2['time_start'].':'.$row2['time_start_min'])).'-';
                                            echo date("g:i A", strtotime($row2['time_end'].':'.$row2['time_end_min'])).')';
                                    ?>
                                    <br>
                                            <?php echo $this->db->get_where('teacher',['teacher_id'=>$row2['teacher_id']])->row()->name;?>
