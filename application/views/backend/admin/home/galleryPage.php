<div class="row">
    <div class="col-md-offset-1 col-md-10">
        ...
        <div class="col-md-4" id="galleryFormSection">
            <form id="addGallery" action="<?php echo base_url() .'index.php?homemanage/ajax_add_gallery'; ?>" class="form-horizontal form-groups-bordered"
      ...
      foreach($gallery as $key=>$list): $info = explode('+', $list['info']); $id = $list['id']; $name = $list['img_name'];?>
                        <tr id="gallery<?php echo $key; ?>">
                            ...
                            <td>
                                <img src="<?php echo base_url().'assets/images/gallery_image/'.$list['img_name'];?>" width="150px" height="100px" />
                            </td>
                            <td>
                                <button href="#" class="btn btn-info btn-xs" onclick="editGallery('<?php echo $list['id'];?>')">
                                    <?php echo lng('Edit');?>
                                </button>
                                <a href="#" class="btn btn-danger btn-xs" onclick="confDelete('homemanage','ajax_delete_galleryImg','<?php echo $id.'-'.$name;?>','gallery<?php echo $key;?>')">
