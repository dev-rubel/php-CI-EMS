...
<div class="row">
    ...
    <div class="col-md-12">
        <div class="row">
            <div class="col-md-4">
                <?php echo flash_msg();?>
                <form action="<?php echo base('homemanage', 'add_notice');?>" method="post" enctype="multipart/form-data">
        ...
        <div class="form-group">
                <label><?php echo lng('Notice File');?></label>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>
          <a href="#" class="btn btn-info btn-xs" onclick="showAjaxModal('<?php echo base_url(); ?>index.php?modal/popup/modal_edit_home_notice/<?php echo $id; ?>');">Edit</a>
          ...
          <a href="<?php echo base('homemanage', 'change_notice_status'."/$id/0");?>" class="btn btn-success btn-xs" onclick="return confirm('Are you sure you want to draft this notice?');"><?php echo lng('Published');?></a>          
        <?php else:?>
          <a href="<?php echo base('homemanage', 'change_notice_status'."/$id/1");?>" class="btn btn-warning btn-xs" onclick="return confirm('Are you sure you want to publish this notice?');"><?php echo lng('Draft');?></a>  
        <?php endif;?>     
      </td>
    </tr>
    <?php endforeach;
