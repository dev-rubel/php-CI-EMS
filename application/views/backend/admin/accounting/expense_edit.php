		...
		<div class="panel panel-primary" data-collapsed="0">
			...
			<div class="panel-body">
                ...
                <?php echo form_open(base_url() . 'index.php?admin/expense/edit/' . $row['payment_id'] , array('class' => 'form-horizontal form-groups-bordered validate', 'enctype' => 'multipart/form-data'));?>
                    ...
                    <?php if($row['student_id'] != 0 || $row['student_id'] > 0): ?>
                    <div class="form-group" id="teachers_area">
                        <label class="col-sm-3 control-label"><?php echo get_phrase('teachers');?></label>
                        <div class="col-sm-6">
                            <select name="teacher_id" class="form-control">
                                ...
                                ?>
                                <option value="<?php echo $row['teacher_id'];?>" <?php echo $row2['teacher_id']==$row['student_id']?'selected':''; ?>><?php echo $row2['name'];?></option>
                            <?php endforeach;?>
                            </select>
                        </div>
                    </div>
