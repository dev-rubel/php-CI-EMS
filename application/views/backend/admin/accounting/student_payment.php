            ...
            <br>
				...
				<div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-9">
                            <input type="text" class="form-control" name="acc_code" id="acc_student_id" placeholder="Shift Class Section Roll Group" required="required" autofocus/>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        ...
                        <table id="dataTable" class="table fee-list">
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="fee_amount[]" pattern=".{3,4}" required title="3 to 4 characters"/></td>
                            </tr>
                        </table>
                        ...
                        <div class="panel panel-default panel-shadow" data-collapsed="0">
                            ...
                            <div class="panel-body">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="amount" id="grandtotal"
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-9">
                                        <input type="text" class="form-control" name="amount_paid" id="payment"
                                            placeholder="<?php echo get_phrase('enter_payment_amount');?>" required="required"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <?php if(isset($_SESSION['sessionSaveDate'])): ?>
                                        <input type="text" class="datepicker form-control" name="date" value="<?php echo $_SESSION['sessionSaveDate']; ?>" readonly required />
                                    <?php else: ?>
...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $("#acc_date").datepicker({format: 'dd-mm-yyyy', startView: 1}).datepicker("setDate", new Date()).on('changeDate', function(e){
