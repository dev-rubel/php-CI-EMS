            ...
            <div class="heading">
                <div class="login-content" style="width:100%;">
                    ...
                    <a href="<?php echo base_url(); ?>" class="logo">
                        <img src="uploads/logo.png" height="60" alt="" style="opacity: .5;"/>
                    </a>

                </div>
                <h2 style="color: rgba(255, 255, 255, 0.2);">Reset Password</h2><br/><br/>
                <form action="<?php echo base('login', 'ajax_forgot_password')?>" method="post">
                ...
                <p><a href="<?php echo base('login', '');?>" style="color: rgba(255, 255, 255, 0.2);">Back to login page.</a></p>
            </div>
        </div>
