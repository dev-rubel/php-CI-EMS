...
$color = ['bg-info','bg-primary','bg-sms','bg-today-app','bg-confirm-app','bg-padding-app','input-group-addon'];
 ?>
<div class="row customNavManu" id="classNavManu">

<?php foreach($links as $k=>$each):?>
    <div class="col-sm-3 col-md-4" style="margin-bottom: 10px;">
...
<div class="row" id="classMainManu">
...
function changePage(page)
{
    ...
    $.ajax({
        ...
        url: '<?php echo base_url(); ?>index.php?teacher/ajax_class_menu_pages',
