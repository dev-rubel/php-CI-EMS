    ...
    <div class="col-md-12">
        ...
        <div class="tab-content">
            ...
            <div class="tab-pane box active" id="list">
                ...
                <div id="editExpenseCategoryHolder"></div>
            ...
            <div class="tab-pane box" id="add" style="padding: 5px">
                <div class="box-content">
					...
					<form id="createExpenseCategory" action="<?php echo base_url() .'index.php?admin/ajax_expense_category_create'; ?>" class="form-horizontal form-groups-bordered" method="post">   
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $('#createExpenseCategory').ajaxForm({
            beforeSend: function () {
                $('#loading2').show();
                $('#overlayDiv').show();
            },
            success: function (data) {
                ...
                if (!jData.type) {
                    ...
                    $('#createExpenseCategory').resetForm();
                }
                $('body,html').animate({
                    scrollTop: 0
                }, 800);
