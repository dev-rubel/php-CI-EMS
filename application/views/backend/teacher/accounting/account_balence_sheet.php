  ...
  <tbody>
    <tr>
      ...
      <?php 
			...
			echo $income !=0? bd_money($income):0;
		 ?>
      </td>
      <td>
      <?php 
			...
			echo $expense !=0? bd_money($expense):0;
		 ?>
      </td>
      <td><?php echo bd_money($income-$expense); ?></td>
    </tr>
  </tbody>
</table>
...
<?php foreach(range(1, 12) as $list): 
    ...
    <tr>
      ...
      <td>
		<?php echo bd_money($income-$expense); ?>
    ...
    <tr>
    	...
    	<td><?php echo bd_money($grand_income); ?></td>
    	<td><?php echo bd_money($grand_expense); ?></td>
    	<td><?php echo bd_money($grand_income-$grand_expense); ?></td>
    </tr>
