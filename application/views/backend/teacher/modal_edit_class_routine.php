    ...
    <div class="box-content">
        ...
        <?php echo form_open(base_url() . 'index.php?admin/class_routine/do_update/'.$row['class_routine_id'] , array('class' => 'form-horizontal validatable','target'=>'_top'));?>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select id="group_id" name="group_id" class="form-control selectboxit">
                            <?php 
                            foreach($groupInfo as $row2):
                            ?>
                                <option value="<?php echo $row2['group_id'];?>" <?php if($row2['group_id']==$row['group_id'])echo 'selected';?>>
                                    <?php echo ucwords($row2['name']);?></option>
                            <?php
                            endforeach;
                            ?>
                        </select>
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-5">
                        <select id="shift_id" name="shift_id" class="form-control selectboxit">
                            <?php 
                            $shifts = $this->db->get('shift')->result_array();
                            foreach($shifts as $row2):
                            ?>
                                <option value="<?php echo $row2['shift_id'];?>" <?php if($row2['shift_id']==$row['shift_id'])echo 'selected';?>>
                                    <?php echo $row2['name'];?></option>
                            <?php
                            endforeach;
                            ?>
