...
<style>
    ...
    li.blinks{
        border: 1px solid; padding: 2px; border-radius: 2px; background: #16A085;
    }
    li.blinks a{
        color: white;
    }
    ...
    .latest_news:before {content: "গুরুত্বপূর্ন নোটিস";position: absolute;display: inline-block;padding: 2px;z-index: 999;font-weight: bold;color: white;padding-left: 15px; padding-right: 15px; padding-top: 8px; height: 40px; margin-left: -15px;
    }
	.latest_news a{
		color: white;
		font-size:16px;
...
<div class="container Pagehead">
	...
	<div class="col-md-12">
        <a href="<?php echo base_url();?>"><div class="col-md-12 wow slideInDown text-center school-head" style="background-image: url('<?php echo base_url().'assets/otherFiles/'.$header_img; ?>');background-size: 100% 100%;background-repeat: no-repeat;background-position: center;height: 200px;">
    ...
    <div class="container">
        <nav class="main-navigation clearfix visible-md visible-lg" role="navigation">
            <ul class="main-menu sf-menu">
                ...
                <li><a href="index.php?Home/allNoticePage">সকল নোটিস</a></li>
                <li style="background: #e74c3c; box-shadow: 0px 0px 14px 0px rgba(0,0,0,0.75);"><a href="index.php?Home/registration_online">ভর্তি আবেদন</a></li>
            </ul>
            <!-- /.main-menu -->
            <ul class="social-icons pull-right">
                ...
                <li><a href="<?php echo base('login', '') ?>" data-toggle="tooltip" title="Login" target="_blank"><i class="fa fa-sign-in" aria-hidden="true"></i></a></li>
            </ul>
            <!-- /.social-icons -->
        </nav>
        <!-- /.main-navigation -->
...
<div class="col-md-12">
    ...
    <b>Date:</b> <span id="date-part"></span> <b>|</b> 
    <b>Time:</b> <span id="time-part"></span>
